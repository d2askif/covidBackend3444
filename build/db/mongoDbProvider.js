...
var MongoDbProvider = (function () {
    function MongoDbProvider(url) {
        ...
        var logCount = 0;
        mongodb_1.Logger.setCurrentLogger(function (msg, state) {
            console.log("MONGO DB REQUEST " + ++logCount + ": " + msg);
        });
        mongodb_1.Logger.setLevel('debug');
        mongodb_1.Logger.filter('class', ['Cursor']);
    }
    Object.defineProperty(MongoDbProvider.prototype, "usersCollection", {
        get: function () {
            var usersCollection = this.getCollection('myUsers');
            if (!usersCollection) {
    ...
    Object.defineProperty(MongoDbProvider.prototype, "locationCollection", {
        get: function () {
            var linkCollection = this.getCollection('locations');
    ...
    Object.defineProperty(MongoDbProvider.prototype, "patientCollection", {
        get: function () {
            var pCollection = this.getCollection('patients');
            if (!pCollection) {
    ...
    MongoDbProvider.prototype.createCollection = function (collectionName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.database.createCollection(collectionName)];
...
exports.mongoDbProvider = new MongoDbProvider(MONGO_URL);
